...
## The 4-Step Phase Workflow
Every time the user asks you to start a new Phase (e.g., "Start Phase 2"), you must execute the following 4 steps strictly in this order:
...
### Step 4: The Interactive Walkthrough (In-Chat)
- This is the most important step! After Steps 1-3 are done, you must guide the user through the new code directly in the chat.
...
---
**AI Acknowledgment:** Once you have read this file, reply to the user confirming that you understand the 4-Step Workflow and are ready to proceed with their next command.
